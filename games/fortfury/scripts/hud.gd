...
func set_special_used(used: bool) -> void:
	_spec_btn.disabled = used
	if used:
		_spec_btn.text = "✓ SPECIAL"
		_style_button(_spec_btn, Color(0.14, 0.10, 0.04), Color(0.42, 0.32, 0.10), Color(0.55, 0.48, 0.28), 8)
	else:
		_spec_btn.text = "* SPECIAL"
		_style_button(_spec_btn, Color(0.42, 0.20, 0.04), Color(0.95, 0.60, 0.10), Color(1.0, 0.84, 0.28), 8)
