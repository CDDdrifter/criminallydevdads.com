...
func _setup_scene() -> void:
	...
	var player_anchor := SLING_X + 120.0
	var enemy_anchor := _world_width - SLING_X - 120.0 - ec_w
...
func _enter_aim_state() -> void:
	...
	_cam_target = Vector2(SLING_X + 280, GROUND_Y - 220)
	var bomb := _spawn_bomb(_available_bombs[_selected_bomb_idx], "player", Vector2(SLING_X, GROUND_Y - 80))
